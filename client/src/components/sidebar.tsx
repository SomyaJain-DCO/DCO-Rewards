...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={cn(
        "sidebar-container w-64 bg-primary text-primary-foreground shadow-lg fixed h-full z-40 transition-transform duration-300 ease-in-out flex flex-col overflow-hidden",
        "lg:translate-x-0",
